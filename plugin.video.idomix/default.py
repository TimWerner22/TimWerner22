#!/usr/bin/python
# -*- coding: utf-8 -*-
import xbmcplugin,xbmcaddon,xbmcgui,xbmc,urllib,urllib2,os,sys,urllib
...
def beautiful_soup_ytpl(r_read):
    ...
    soup = BeautifulSoup(r_read, "html.parser")
    for li in soup.findAll('li'):
        ...
        if li:
            ...
            if img:
                ...
                if  not video_titel == None and not 'Video]' in video_titel and not video_id == None :
